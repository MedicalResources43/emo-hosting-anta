...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-zh13us.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-zh13us.containers.anotherwebservice.com/
...
```
git clone git@github.com:MedicalResources43/emo-hosting-anta.git
cd container-zh13us
```
...
```
docker attach container-zh13us
```
